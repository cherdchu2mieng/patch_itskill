...
# itgo Genesis (v1.1.0)
source "$SCRIPT_DIR/itgo_genesis@v1.1.0.sh"
source "$SCRIPT_DIR/rich_manifest_itgo@v1.1.0.sh"
source "$SCRIPT_DIR/refine_cr001@v1.1.0.sh"
source "$SCRIPT_DIR/itgo_refresh@v1.1.0.sh"
source "$SCRIPT_DIR/unified_scanner@v1.2.0.sh"
source "$SCRIPT_DIR/fleet_health@v1.3.0.sh"
source "$SCRIPT_DIR/advanced_governance@v1.4.0.sh"
source "$SCRIPT_DIR/agent_sync@v1.5.0.sh"
source "$SCRIPT_DIR/genesis_closure@v1.6.0.sh"
