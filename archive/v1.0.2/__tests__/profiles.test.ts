// @it-skill-patch: it_skill_profiles_test@v1.2
...
describe("profiles", () => {
  ...
  it("standard has 4 skills", () => {
    expect(STANDARD_SKILLS).toHaveLength(4);
  });
...
describe("resolveProfile", () => {
  ...
  it("standard returns 4 skills", () => {
    const result = resolveProfile("standard", ALL_SKILLS);
    expect(result).toHaveLength(4);
  });

  it("full returns everything minus zombies (4 skills)", () => {
