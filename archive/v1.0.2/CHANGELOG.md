...
- Prevents `command not found: it-skill` on nodes without global install
...
- Fix repo name refs to it-skill-cli (#171)
...
- CLI renamed: oracle-skills → it-skill
...
| Install | `oracle-skills` | `it-skill` |
